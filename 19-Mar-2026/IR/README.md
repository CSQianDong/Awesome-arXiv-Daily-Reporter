...
**Link**: [PDF](https://arxiv.org/pdf/2603.17580)  
...
**Link**: [PDF](https://arxiv.org/pdf/2603.17315)  
...
**Link**: [PDF](https://arxiv.org/pdf/2603.17916)  
...
Firstly, we consider the case when the cost of querying a vertex is independent of the target. We develop a $\br{4+\epsilon}$-approximation FPTAS for trees running in $O(n^4/\epsilon^2)$ time and an $O({\sqrt{\log n}})$-approximation for general graphs. Additionally, we give an FPTAS parametrized by the number of non-leaf vertices of the graph. On the hardness side we prove that the problem is NP-hard even when the input is a tree with bounded degree or bounded diameter.
...
**Link**: [PDF](https://arxiv.org/pdf/2603.17392)  
...
**Link**: [PDF](https://arxiv.org/pdf/2603.17223)  
...
**Link**: [PDF](https://arxiv.org/pdf/2603.17186)  
...
**Link**: [PDF](https://arxiv.org/pdf/2603.17168)  
